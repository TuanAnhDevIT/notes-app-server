...
import * as authMethod from "./auth.methods";
...
const jwtVariable = {
  refreshTokenSize: 40, // Kích thước của refresh token
};
...
exports.login = async (req: Request, res: Response) => {
  ...
  const accessTokenLife = process.env.ACCESS_TOKEN_LIFE ?? "default_value";
